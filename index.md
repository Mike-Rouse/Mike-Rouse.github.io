...
**72 FPS** (Quest 2/3 & Pico) · **≥99% crash-free** (Unity Cloud Diagnostics) · **Team 4** · Unity **2022**, **URP**, **XR Interaction Toolkit**

### Why it mattered

- Commissioned by **Gwynedd Council**; later funded by **Adnodd** for public release.
- Demonstrates reliable release ops + measurable quality.

### Tech highlights

- XRI + OpenXR interactions; authoring workflow for minigames.  
